...
public class tough
{
    ...
    public static HashMap<Integer, Character> theflags2 = new HashMap<>(); //note that this one is never really used
    public static boolean m = true;
    public static boolean g = false;
    
    public static void main(String args[]) {
        String input = "AAAAAAAAAAAAAAAAAAAAAAAA"; //placeholder for correct length as input
        if (check(input)) {
